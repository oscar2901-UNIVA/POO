...
public class Ingreso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(340, 250, 100, 30);

        jLabel2.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel2.setText("Contraseña:");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(330, 390, 140, 30);
        ...
        txtUsuario.setBounds(480, 250, 161, 30);
        getContentPane().add(txtpassword);
        txtpassword.setBounds(480, 390, 161, 30);
        ...
        btnIngresar.setBounds(140, 580, 240, 90);
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        for(Usuarios fila:datos){
                if(fila.getId().equals(id)&&fila.getPassword().equals(contra)){
                    resultado = true;
